...
<div class="container">
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-center">
            <img width="150" src="{{ asset('images/logo-pnj.svg') }}" alt="Logo">
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <p class="text-center mt-5 lead">
                Developed By
                <a href="https://pnj.ac.id/" class="font-weight-bold text-primary">SIAMI Politeknik Negeri Jakarta</a><p><center>All rights reserved.</center></p>
            </p>
        </div>
    </div>
</div>
