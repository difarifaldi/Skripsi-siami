...
{{-- start KUI --}}
@can('access_KUI')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('kui*') ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="c-sidebar-nav-icon bi bi-calculator" style="line-height: 1;"></i> KUI
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
            @can('create_KUI')
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link {{ request()->routeIs('kui.create') ? 'c-active' : '' }}"
                        href="{{ route('kui.create') }}">
                        <i class="c-sidebar-nav-icon bi bi-journal-plus" style="line-height: 1;"></i> Admin
                    </a>
                </li>
            @endcan
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('kui.index') ? 'c-active' : '' }}"
                    href="{{ route('kui.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-building" style="line-height: 1;"></i>
                    {{ auth()->user()->roles[0]->id == 4 ? 'auditor' : 'auditee' }}
                </a>
            </li>
