...
class UsersDataTable extends DataTable
{
    ...
    public function dataTable($query) {
        return datatables()
            ...
            ->addColumn('jurusan', function ($data) {
                return Jurusan::find($data->id_jurusan)->nama_jurusan;
            })
            ->addColumn('prodi', function ($data) {
                return Prodi::find($data->id_prodi)->nama_prodi;
            })
            ->addColumn('jenjang_prodi', function ($data) {
                return JenjangProdi::find($data->id_jenjang_prodi)->nama_jenjang_prodi;
            })
    ...
    protected function getColumns() {
        return [
            ...
            Column::make('ruang_lingkup_audit')
                ->className('text-center align-middle'),
