                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="ruang_lingkup_audit" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jenjangProdi" id="jenjangProdi" required>
                                    ...
                                    @foreach(App\Models\JenjangProdi::all() as $jenjangProdi)
                                            <option value="{{ $jenjangProdi->nama_jenjang_prodi }}">{{ $jenjangProdi->nama_jenjang_prodi }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
