                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="access_KUI" name="permissions[]" value="access_KUI"
                                                            {{ $role->hasPermissionTo('access_KUI') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="access_KUI">Lihat
                                                            Instrument</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="create_KUI" name="permissions[]" value="create_KUI"
                                                            {{ $role->hasPermissionTo('create_KUI') ? 'checked' : '' }}>
                                                        <label class="custom-control-label" for="create_KUI">Buat
                                                            Instrument</label>
                                                    </div>
                                                </div>
